...
app.post("/validarHoras", async (req, res) => {
    try {
        ...
        // 5. Obtener capacidad especial del día
        ...
        // 6. Generar todas las horas posibles en el rango
        ...
        res.json({
            ...
            capacidadEspecial: capacidadEspecial[0] || null
        });
